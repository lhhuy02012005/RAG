...
from app.services.models.rag_types import RAGQueryResult, RetrievedChunk
from app.services.document_events import publish_document_status
...
) -> "RAGService | DeepRAGService":
    """Factory function: routes to RAGService or legacy RAGService based on config."""
    from app.core.config import settings

    if settings.RAG_ENABLED:
        from app.services.deep_rag_service import DeepRAGService
        return DeepRAGService(
            db=db,
